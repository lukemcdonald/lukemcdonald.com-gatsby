...
async function createAboutPages({ graphql, actions, reporter }) {
  const { data, errors } = await graphql(`
    query {
      about: allMarkdownRemark(filter: { fields: { type: { eq: "i-am-a" } }, frontmatter: { draft: { eq: false } } }) {
        nodes {
          fields {
            path
            slug
...
async function createPagePages({ graphql, actions, reporter }) {
  const { data, errors } = await graphql(`
    query {
      pages: allMarkdownRemark(filter: { fields: { type: { eq: "page" } }, frontmatter: { draft: { eq: false } } }) {
        nodes {
          fields {
            path
            slug
...
async function createPostPages({ graphql, actions, reporter }) {
  const { data, errors } = await graphql(`
    query {
      posts: allMarkdownRemark(filter: { fields: { type: { eq: "post" } }, frontmatter: { draft: { eq: false } } }) {
        nodes {
          fields {
            path
            slug
...
async function createWorkPages({ graphql, actions, reporter }) {
  const { data, errors } = await graphql(`
    query {
      works: allMarkdownRemark(filter: { fields: { type: { eq: "work" } }, frontmatter: { draft: { eq: false } } }) {
        nodes {
          fields {
            path
            slug
